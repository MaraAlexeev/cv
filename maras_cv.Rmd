...
```{r}
if(params$pdf_mode){
  cat("[View this CV online with links](https://maraalexeev.github.io/cv/)")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://maraalexeev.github.io/cv/)")
}
```
...
Medical Work Experience {data-icon=suitcase}
--------------------------------------------------------------------------------

::: aside
```{r}
CV %<>% print_text_block('medical_work_experience_aside')
```
:::
...
Medical Credentials  {data-icon=medkit}
--------------------------------------------------------------------------------
