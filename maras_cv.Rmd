...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/MaraAlexeev/cv/blob/master/docs/public_cv.pdf)")
}
```
...
Awards and Honors  {data-icon=medkit}
--------------------------------------------------------------------------------
